...
function(add_gba_target target_ sources_)
    ...
    if (CMAKE_BUILD_TYPE STREQUAL "Debug")
        message("Warning: Building with debug options")
        target_compile_options(${target_} PRIVATE -g -mthumb-interwork -mthumb -O0)
        target_link_options(${target_} PRIVATE -g -mthumb-interwork -mthumb -specs=gba.specs)
    elseif(CMAKE_BUILD_TYPE STREQUAL "Release")
        target_compile_options(${target_} PRIVATE -mthumb-interwork -mthumb -O3)
